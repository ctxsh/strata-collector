...
func (f *sharedInformerFactory) ForResource(resource schema.GroupVersionResource) (GenericInformer, error) {
	...
	case v1beta1.SchemeGroupVersion.WithResource("discoveries"):
		return &genericInformer{resource: resource.GroupResource(), informer: f.Strata().V1beta1().Discoveries().Informer()}, nil
